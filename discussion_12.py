...
def job_and_hire_date(cur, conn):
    cur.execute('SELECT employees.hire_date, jobs.job_title FROM jobs INNER JOIN employees ON jobs.job_id = employees.job_id ORDER BY hire_date LIMIT 1')
    x = cur.fetchone()
    # returns a tuple so you just want the job_title
    return x[0]
